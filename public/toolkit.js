...
{name:'Outlook Mail',app:'outlook',intro:'Wir schreiben Kerim eine erste Mail und senden ihm am Ende alle erstellten Dateien. Empfänger und Anhänge werden vor dem Senden geprüft. Funktionen hängen von Konto, Plugin und Freigaben ab.',items:[
...
['Datei anhängen','Prüfe die Anhangsfunktion und Größenlimits deines Plugins. Bei fehlender Funktion selbst in Outlook anhängen.','Hänge diese geprüfte PDF an genau diesen Entwurf an.','Richtigen Anhang im Entwurf öffnen.'],
...
['Senden und später senden','Beides sind echte Handlungen. Eine geplante Mail kann ohne weiteres Zutun versendet werden.','Zeige Empfänger, Text, Anhang und Versandzeit zur Kontrolle.','Nach der Prüfung gezielt an Kerim Seehafer senden.','Vertiefung'],
...
['Suchen und öffnen','Dateiname plus Ordner schränkt die Suche sinnvoll ein.','Finde Hadi_Steckbrief.txt in meinem Übungsordner.','Datei öffnen, Datum und Inhalt vergleichen.'],
...
['Umbenennen und verschieben','Eindeutigen Quellnamen und Zielordner nennen.','Benenne nur die neue Kopie in Hadi_Steckbrief_Firma.pdf um.','Neuer Name, richtiger Ordner, Original erhalten.'],
...
{name:'Outlook Kalender',app:'outlook',intro:'Im Seminar laden wir Kerim Seehafer am 25. Dezember ein. Änderungen und Absagen können weitere Nachrichten an ihn auslösen.',items:[
...
['Termin anlegen','Titel, Anfang, Ende, Ort, Agenda und Teilnehmer bewusst festlegen.','Erstelle nach meiner Prüfung den Weihnachtstermin und lade Kerim Seehafer über seine geprüfte Adresse ein.','Im eigenen Outlook-Kalender öffnen.'],
...
['Entfernen oder absagen','Löschen im eigenen Kalender und Absage an Gäste unterscheiden.','Zeige den Weihnachtstermin mit Kerim und bereite eine Absage vor. Frage vor dem Senden.','Nur die Übung wurde entfernt.'],
