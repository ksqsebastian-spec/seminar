...
test('eleven sequential lessons teach and verify work in participants own accounts',async()=>{
 assert.equal(c.lessons.length,11);assert.equal(new Set(c.lessons.map(l=>l.id)).size,11);
