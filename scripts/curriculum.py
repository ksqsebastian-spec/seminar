...
lesson('dokument','ChatGPT füllt das Angebot aus.','Eine echte Vorlage bearbeiten.',['chatgpt','word'],60,
 ...
 q('Die Vorlage fragt nach einer bestätigten Lieferzeit. Wir haben keine.','Eine plausible Woche einsetzen.','Offenlassen oder als Vorschlag kennzeichnen.',1,'Die KI darf aus unserer Idee keine Zusage machen.'),[template,brief,sheet],'Lass die Einleitung für einen sachlichen und einen etwas mutigeren Stil formulieren.','Die geprüften Angaben fließen in Mission_Hadi.pdf für Kerim ein.'),
lesson('antwort','Kerim, wir haben Großes vor!', 'Korrespondenz suchen, Kontakt finden, Entwurf mit Anhang.',['chatgpt','outlook','onedrive'],55,
 ...
 demo('Mach eine Mission-PDF.','Nutze den Schrankbrief und deine geprüfte Kalkulation. Erstelle eine Seite und öffne sie vor dem Anhängen.','Erstelle Mission_Hadi.pdf als einseitigen Projekt-Steckbrief: Titel „Ein Schrank für Hadi“, unsere Schrankidee, Maße als Übungsannahmen, aktueller Angebotspreis aus meiner Kalkulation mit klarer Netto-/Bruttoangabe und drei offene Fragen. Kennzeichne die Zusammenarbeit als Seminar-Rollenspiel ohne Zusage. Speichere die PDF in meinem OneDrive-Ordner Seminar Schrank.','Die PDF liegt im eigenen Ordner und lässt sich öffnen.'),
 ...
 ['Korrespondenz suchen und Kerims Kontakt prüfen.','Mission_Hadi.pdf aus deinen Projektdateien erstellen und öffnen.','Mailtext verbessern, als Entwurf an Kerim speichern und PDF anhängen.'],
